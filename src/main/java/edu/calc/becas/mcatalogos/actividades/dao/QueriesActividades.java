...
final class QueriesActividades {
    ...
    static final String QRY_UPDATE_HORA_ACTIVIDAD = "UPDATE HORARIO_ACTIVIDAD SET HORA = ?, AM_PM = ?, " +
            "NUMERO_ALUMNOS = ?, ID_USUARIO = ?, ESTATUS = ?, COMENTARIO = ?, ACTUALIZADO_POR = ?, FECHA_ACTUALIZACION= NOW() WHERE ID_HORARIO_ACTIVIDAD = ?";
    ...
    static final String QRY_AlUMNOS_ACTIVIDAD = "SELECT MATRICULA, CVE_GRUPO, CVE_LICENCIATURA FROM ALUMNOS_DAT_PERIODO\n" +
      "INNER JOIN ACTIVIDAD_ALUMNO AA on ALUMNOS_DAT_PERIODO.ID_ALUMNOP = AA.ID_ALUMNO_P\n" +
      "WHERE AA.ID_HORARIO_ACTIVIDAD = ?";
