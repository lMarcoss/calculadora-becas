...
public class QueriesAlumnos {
    ...
    static final String QRY_ALUMNOS_CARGAS = "SELECT ID_ALUMNO, AL.MATRICULA, CURP, NOMBRES, APE_PATERNO, APE_MATERNO, CVE_GRUPO, DESC_GRUPO, ESTATUS FROM ALUMNOS AL\n" +
