...
final class QueriesUsuario {
    ...
    static final String QRY_GET_ALL = "SELECT U.ID_USUARIO, U.NOMBRES, U.APE_PATERNO, U.APE_MATERNO,  U.USERNAME, U.ESTATUS, R.NOMBRE_ROL TIPO_USUARIO,R.ID_ROL, U.DIAS_RETROCESO_REPORTE\n" +
    ...
    static final String QRY_UPDATE =
            "UPDATE USUARIOS\n" +
                    ...
                    " DIAS_RETROCESO_REPORTE= ?, ESTATUS   = ?, ACTUALIZADO_POR = ?, FECHA_ACTUALIZACION = NOW() \n" +
                    "WHERE ID_USUARIO = ?";
