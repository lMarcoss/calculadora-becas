...
class QueriesLogin {
    ...
    static final String QRY_GET_INFO_ALUMNO = "SELECT ID_ALUMNO,NOMBRES, APE_PATERNO, APE_MATERNO, '3' ID_ROL, 'ALUMNO' ROL, AC.MATRICULA as USERNAME, CURP COMMONVAL01, AC.CVE_GRUPO COMMONVAL02,\n" +
            ...
            "    WHERE AL.MATRICULA = AC.MATRICULA AND AC.MATRICULA = ? and AC.ESTATUS = 'S' ORDER BY AC.ID_ALUMNOP DESC LIMIT 1";

    static final String QRY_VALIDA_USUARIO = "SELECT DISTINCT U.ID_USUARIO, R.NOMBRE_ROL, U.NOMBRES, U.APE_PATERNO, U.APE_MATERNO, U.D_TOLERANCIA_REP \n" +
