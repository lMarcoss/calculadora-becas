...
final class QueriesAsistenciaSala {
    ...
    static final String GET_ALUMNOS_BY_USER_AND_SCHEDULE = "SELECT U.D_TOLERANCIA_REP, AA.ID_ACTIVIDAD_ALUMNO, U.ID_USUARIO, A.MATRICULA, A.NOMBRES,  A.APE_PATERNO, A.APE_MATERNO, HA.ID_HORARIO_ACTIVIDAD\n" +
